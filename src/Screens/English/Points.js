  ...
  render() {
    return (
      <View style={{ flex: 1 , backgroundColor:'rgba(0, 0, 0, 0.8)'  , justifyContent:'flex-end' , overflow:'hidden'}}>
             <View style={{backgroundColor:'orange' , height:'35%'   , borderTopLeftRadius:35, borderTopRightRadius:35 , justifyContent:'center' , alignItems:'center'}} >
               <TouchableOpacity 
            
                onPress={() => Navigation.push(this.props.componentId, { component: { name: 'Deepblue.PlacesFavorite'} })}
            ...
            favorite
               ...
               <TouchableOpacity 
                onPress={() => Navigation.push(this.props.componentId, { component: { name: 'Deepblue.PlacesSeanplace'} })}
                
               style={{height:height*0.075 , marginTop:20 , width:'75%' , alignSelf:'center' , justifyContent:'center' , alignItems:'center' , backgroundColor:'#fff' , borderRadius:30}}>
              <Text style={{textAlign:'center' , fontFamily:'IRANYekanBold' , fontSize:24 , color:'#000'}}>
              seanplace's
              </Text>
               </TouchableOpacity>
